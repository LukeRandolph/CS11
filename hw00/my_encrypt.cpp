...
// Edited for HW0 by: Luke Randolph
...
int main()
{
    ...
    cout << "This program encrypts words!";
    cout << endl;

    // Prompt the user for a word to encrypt
    cout << "Choose a word (in lowercase letters): ";
    // Retrieve the word from the user and store it in our variable
    cin >> word_to_encrypt;
